const cart = document.querySelector('.svg svg');
...
const addToCartItem = document.querySelector('.btn-add-to-cart');


let itemInCart = 1; 
const countProducts = document.querySelector('.svg-item');
...
const addItem = () => {
    ...
    const newPrice = document.querySelector('.new-price-item').textContent;
    const nameItem = document.querySelector('.info-shoes').textContent;

    const modalItem = document.querySelector('.modal-item');
    const emptyCart = document.querySelector('.modal-empty');
    ...
    modalItem.innerHTML = `
        <div class="cart-img-small-size">
            <img src="./images/image-product-1-thumbnail.jpg"/>
        </div>
        <div class="cart-item-name">
            <h4>${nameItem}</h4>
            <p class="new-price-cart">$${newPrice}</span><span class="multiplication">x</span><span class="itemsInCart">${items}</span><span class="result">$${priceItem}</span></p>
        </div>
            <p class="delete">
    ...
    if(addToCart){
        ...
        `
            <p class="svg-item-is-full">${itemInCart}</p>
        `
    } 
